	...
	<br>
  	...
  	<div class="card mx-auto">
  		<div class="container">
  			...
  			<div class="card-body">	
  				<div>Welcome to the Admin Page of CodeSmode!</div>
          <div>Here you can <a href="comp2.php" style="color: black"><b>add</b></a> more questions to the already exisiting Questions repository or <a href="edit.php" style="color: black"><b>edit</b></a> them!</div> 
