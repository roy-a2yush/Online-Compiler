...
<?php 
  ...
  $sql="UPDATE `questions` SET `testcase2`='".$testcase2."' WHERE `qname`='".$qname."'";
  $conn -> query($sql);  
	...
	<br>
  	<div class="card mx-auto">
          ...
          <div class="form-group row">
                    <label class="col-2 col-form-label">Enter test case 3 (3/3)</label>
                    <div class="col-10">
                      <textarea id="testcase3" name="testcase3" rows="10" cols="120" required></textarea>
                    </div>
            </div>
